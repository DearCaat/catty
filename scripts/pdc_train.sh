...
case "$CONN_HOST" in
    "3090") data_path="/data/tangwenhao/pdc/"; output_path="/data/tangwenhao/output/";;
    "amax") data_path="/data/zhangxiaoxian/pdc/"; output_path="/nas/zhangxiaoxian/output/"; extra_opt="DATA.VAL_BATCH_SIZE 12";;
    "DGX") data_path="/raid/Data/zhangyi/pdc/"; output_path="/raid/Data/zhangyi/output/";;
    "3090_1") data_path="/home/tangwenhao/dataset/pdc/"; output_path="/data/tangwenhao/output/";;
    "2080") data_path="/home/tangwenhao/data/pdc/"; output_path="/home/tangwenhao/output/"; extra_opt="DATA.VAL_BATCH_SIZE 12";;
...
python3 $multi_gpu_str ../main.py --data-path=$data_path$CONN_DATASET"/data/" --output=$output_path --project=$CONN_PROJECT --cfg $config $bs_str --title=$CONN_TITLE $log_wandb_str $ema_str $p_m_str $opt_str