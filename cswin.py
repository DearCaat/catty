from timm.models.cait import checkpoint_filter_fn
import torch
...
def CSWin_64_12211_tiny_224(pretrained=False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url="https://github.com/microsoft/CSWin-Transformer/releases/download/v0.1.0/cswin_tiny_224.pth",
...
def CSWin_64_24322_small_224(pretrained=False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url="https://github.com/microsoft/CSWin-Transformer/releases/download/v0.1.0/cswin_small_224.pth",
            map_location="cpu", check_hash=True
        )
        cpt = checkpoint
        model.load_state_dict(cpt,strict=False)
