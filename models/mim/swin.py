...
Modifications for mim architecture by Wenhao Tang, thanks to simmim's authors and mae's authors
"""
# --------------------------------------------------------
# Swin Transformer
...
class SwinTransformer(nn.Module):
    ...
    def init_weights(self, mode=''):
        ...
        # timm 0.5.4 doesn't have get_init_weights_vit
    ...
    def no_weight_decay(self):
        ...
        # for mim, ref to https://github.com/microsoft/SimMIM/blob/main/models/simmim.py
        if self.mask_token is not None:
            nwd.add('mask_token')
...
@register_model
def swin_mim_base_patch4_window12_384(pretrained=False, **kwargs):
...
@register_model
def swin_mim_base_patch4_window7_224(pretrained=False, **kwargs):
...
@register_model
def swin_mim_large_patch4_window12_384(pretrained=False, **kwargs):
...
@register_model
def swin_mim_large_patch4_window7_224(pretrained=False, **kwargs):
...
@register_model
def swin_mim_small_patch4_window7_224(pretrained=False, **kwargs):
...
@register_model
def swin_mim_tiny_patch4_window7_224(pretrained=False, **kwargs):
...
@register_model
def swin_mim_large_patch4_window12_384_in22k(pretrained=False, **kwargs):
...
@register_model
def swin_mim_large_patch4_window7_224_in22k(pretrained=False, **kwargs):
...
@register_model
def swin_mim_s3_tiny_224(pretrained=False, **kwargs):
...
@register_model
def swin_mim_s3_small_224(pretrained=False, **kwargs):
...
@register_model
def swin_mim_s3_base_224(pretrained=False, **kwargs):
