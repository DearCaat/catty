...
# python3 main.py --data-path=/mnt/d/wsl/data/cqu_bpdd/ --output=/mnt/d/wsl/output/ --title=resnet50_7 --model-name=resnet50 --thumb --opts MODEL.NUM_CLASSES 7
# python3 main.py --data-path=/mnt/d/wsl/data/cqu_bpdd/ --output=/mnt/d/wsl/output/ --title=vgg16_7 --model-name=vgg16 --thumb --opts MODEL.NUM_CLASSES 7 TRAIN.LR_SCHEDULER.NAME 'cosine' TRAIN.OPTIMIZER.NAME 'lookahead_adamw'

# python3 main.py --data-path=/mnt/d/wsl/data/cqu_bpdd/ --output=/mnt/d/wsl/output/ --title=inception_v3_7 --model-name=tf_inception_v3 --thumb --opts DATA.IMG_SIZE '(299,299)' MODEL.NUM_CLASSES 7

# python3 main.py --data-path=/mnt/d/wsl/data/cqu_bpdd/ --output=/mnt/d/wsl/output/ --title=vit_s_7 --model-name=deit_small_patch16_224 --thumb --opts MODEL.NUM_CLASSES 7 TRAIN.BASE_LR '1e-4' TRAIN.LR_SCHEDULER.NAME 'cosine' TRAIN.OPTIMIZER.NAME 'lookahead_adamw' --epochs=20

# python3 main.py --data-path=/mnt/d/wsl/data/cqu_bpdd/ --output=/mnt/d/wsl/output/ --title=vit_b_7 --model-name=deit_base_patch16_224 --thumb --opts MODEL.NUM_CLASSES 7 TRAIN.BASE_LR '1e-4' TRAIN.LR_SCHEDULER.NAME 'cosine' TRAIN.OPTIMIZER.NAME 'lookahead_adamw' --epochs=20
